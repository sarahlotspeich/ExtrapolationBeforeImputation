...
# cohort analysis and imputation approaches using the estimated ////////
# survival function, assuming that $X$ was independent of $Z$." ////////
# //////////////////////////////////////////////////////////////////////
...
res = read.csv(file = "https://raw.githubusercontent.com/sarahlotspeich/ExtrapolationBeforeImputation/main/Table-Data/data_TableS1.csv")
...
res |> 
  ...
  ) ## Just 19 replicates out of 12,000 did not converge

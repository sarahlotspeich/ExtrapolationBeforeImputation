...
res = read.csv(file = "https://raw.githubusercontent.com/sarahlotspeich/hybridCMI/main/Table-Data/data_TableS1.csv")
...
## Light 12% (3-24%)
## Heavy 41% (26-63%)
## Extra heavy 78% (64-91%)

# //////////////////////////////////////////////////////////////////////
# Create plot summarizing % censoring across settings //////////////////
# //////////////////////////////////////////////////////////////////////
res |> 
  mutate(n = factor(x = n, 
  ...
  geom_hline(yintercept = 0.41, linetype = 2) + 
  geom_hline(yintercept = 0.775, linetype = 2) + 
  xlab("Sample Size") + 
  ylab("Percent Censored Observations") + 
  ggthemes::scale_fill_colorblind(name = "") + 
  theme(legend.position = "top") + 
  scale_y_continuous(labels = scales::percent, breaks = c(0, 0.12, 0.41, 0.775, 1))
ggsave(filename = "TableS1_PercentCensored_Boxplot", device = "png", width = 10, height = 6, units = "in")

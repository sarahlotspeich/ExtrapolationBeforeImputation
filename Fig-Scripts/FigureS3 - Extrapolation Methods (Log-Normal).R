...
res = read.csv(file = "https://raw.githubusercontent.com/sarahlotspeich/ItsIntegral/main/Fig-Data/sims_FigureS3.csv")
...
# //////////////////////////////////////////////////////////////////////
res |>
  dplyr::mutate(censoring = factor(censoring, levels = c("Light", "Moderate", "Heavy"),
...
## Note: 10 rows will be removed because beta_aq is NA 

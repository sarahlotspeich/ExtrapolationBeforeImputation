...
res = read.csv(file = "https://raw.githubusercontent.com/sarahlotspeich/ExtrapolationBeforeImputation/main/Table-Data/data_TableS2_R1_CSB.csv")
...
res |> 
  ...
  arrange(desc(reps_na_extrap)) ## Converged in 99.8%+ of replicates per setting
